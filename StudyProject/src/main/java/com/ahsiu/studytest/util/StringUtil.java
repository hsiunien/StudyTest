...
public class StringUtil {
    ...
    public static boolean startsWithIgnoreCase(String source, String prefix) {
        if (source != null && prefix != null) {
            if (source.startsWith(prefix)) {
                ...
                return (StringUtil.toLowerCase(source)).startsWith(StringUtil
                        .toLowerCase(prefix));
            }
        }
        return false;
    ...
    public static boolean startsWithIgnoreCase(String source, String prefix,
        ...
        if (source != null && prefix != null) {
            if (source.startsWith(prefix, toOffset)) {
                ...
                return (StringUtil.toLowerCase(source)).startsWith(
                        StringUtil.toLowerCase(prefix), toOffset);
            }
        }
        return false;
    ...
    public static String[] toStringArray(int[] intArray) {
        ...
        for (int i = 0; i < length; i++) {
            strArray[i] = StringUtil.toString(intArray[i]);
        }
        return strArray;
    }
    ...
    public static String firstLetterUpper(String str) {
        if (StringUtil.isBlank(str)) {
            ...
            return StringUtil.EMPTY + Character.toUpperCase(str.charAt(0));
        } else {
    ...
    public static String firstLetterLower(String str) {
        if (StringUtil.isBlank(str)) {
            ...
            return StringUtil.EMPTY + Character.toLowerCase((str.charAt(0)));
        } else {
            char headerChar = str.charAt(0);
    ...
    public static String omitString(String source, int maxLength, String omitStr) {
        if (StringUtil.length(source) < maxLength) {
            return source;
        } else {
            return StringUtil.subString(source, 0, maxLength) + omitStr;
        }
    }

    public static String omitString(String source, int maxLength) {
        return StringUtil.omitString(source, maxLength, "...");
    }
    /*
