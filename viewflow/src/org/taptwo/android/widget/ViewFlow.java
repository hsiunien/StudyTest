...
//			childState = child.getMeasuredState();
            childState=ViewFlowFix.getMeasuredState(child);
        ...
        switch (widthMode) {
            ...
            case MeasureSpec.EXACTLY:
                if (widthSize < childWidth + widthPadding)
                    widthSize |=0x01000000 /*MEASURED_STATE_TOO_SMALL*/;
                break;
        }
        switch (heightMode) {
            case MeasureSpec.UNSPECIFIED:
                ...
                break;
            case MeasureSpec.AT_MOST:
                heightSize = (childHeight + heightPadding) | (childState >>16 /*MEASURED_HEIGHT_STATE_SHIFT*/);
                break;
            case MeasureSpec.EXACTLY:
                if (heightSize < childHeight + heightPadding)
                    heightSize |= 0x01000000/*MEASURED_STATE_TOO_SMALL*/;
                break;
        }
        ...
        if (heightMode == MeasureSpec.UNSPECIFIED) {
            ...
            heightSize |= (childState& 0xff000000/*MEASURED_STATE_MASK*/);
        }
